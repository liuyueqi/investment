import math
# import re  # UNUSED with dead index helpers
...
# from common.date_range_util import iter_day_ranges, iter_fortnight_ranges, iter_week_ranges  # UNUSED
# from domain.basket import Basket, BasketType  # UNUSED
...
# from infra.config import get_market_earliest_date  # UNUSED
from infra.log import logger

# UNUSED: 仅服务于不可达的 get_all_indexes / get_all_sectors
...
class TushareAdapter:
    ...
    # _DC_INDEX_ROW_LIMIT = 5000  # UNUSED
    # _DC_MEMBER_ROW_LIMIT = 8000  # UNUSED
    ...
    def __init__(self):
        ...
        # self._index_ts_code_cache: Dict[str, str] = {}  # UNUSED
...
# UNUSED: get_all_sectors 不可达（SectorRepository._update_from_adapter 已停用）
#     def get_all_sectors(
#         self,
...
# UNUSED: get_constituents_history / _resolve_index_ts_code 不可达
